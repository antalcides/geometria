...
%\end{quote}
\chapterimage{./1.jpg}
\chapter{\'Area , per\'imetro y volumen  }
\label{chap:2}
\vspace{40pt}
\section*{Introducci\'on}
 En este cap\'itulo veremos las propiedades de las circunferencias

\section{Postulados del \'area}

\begin{definicion}{Una regi\'on poligonal es un subconjunto de un plano
acotado por un poligono}{}
\end{definicion}

\begin{postulado}{A cada regi\'on poligonal se le puede asignar un n\'umero
positivo \'unico denominado \'area }{}

\end{postulado}

\begin{postulado}{Si dos rect\'angulos o dos tri\'angulos son congruentes,
entonces, las regiones que acotan tienen la misma \'area.}{}
\end{postulado}

\begin{postulado}{Si una regi\'on poligonal es la uni\'on de $n$ regiones
poligonales que no se solapan, su \'area  es la suma de las \'areas de las $n$
regiones. }{}
 \end{postulado}
\begin{postulado}{El \'area de un rect\'angulo de longitud $l$ y ancho $w$
est\'a dada por la f\'rmula $lw$}{}
\end{postulado}
\begin{definicion}{Una unidad cuadrada es una regi\'on cuadrada en la cual
cada uno de sus lados mide una unidad de longitud.}{}

\end{definicion}
\begin{teorema}{Dado un paralelogramo con base $b$ y altura correspondiente
$h$, el \'area $A$ est\'a dada por la f\'ormula $A=bh$}{}
\end{teorema}
\begin{teorema}{Dado un tri\'angulo con base $b$ y altura correspondiente
$h,$ el \'area $A$ est\'a dada por la f\'ormula $A=\frac{1}{2}bh$}{}
\end{teorema}
\begin{teorema}{Dado un trapecio con bases $b_1 $ y $b_2,$ y altura $h,$ el
\'area $A$ est\'a dada por la f\'ormula $A=\frac{}1{2}h(b_1 + b_1)$ }{}
\end{teorema}
\begin{teorema}{Dado un pol\'igono regular de $n$ lados de longitud $s$ y
apotema $a,$ el \'area $A$ est\'a dada por la f\'ormula $A=(\frac{1}{2}ans) $
}{}
 
\end{teorema}

\begin{teorema}{La raz\'on entre los per\'imetros de dos pol\'igonos semejantes
es igual a la raz\'on entre las longitudes de cualquier par de lados
correspondientes. }{}

\end{teorema}
\begin{teorema}{La raz\'on entre las \'areas de dos pol\'igonos semejanntes
es igual al cuadrado de la razo\'on entre las longitudes de cualquier par de
lados correspondientes}{}

\end{teorema}
\begin{teorema}{La raz\'on entre la circunferencia y el di\'ametro es la
misma para todos las circunferencias.}{}
\end{teorema}
\begin{teorema}{Dada una circunferencia de radio $r$ y di\'ametro $d,$ la
circunferencia $C$ est\'a dada por la f\'ormula $C=\pi d$}{}
\end{teorema}

\begin{teorema}{Dado un circulo de radio $r,$ el \'area est\'a dada por la
f\'ormula $A=\pi r^2$ }{}

\end{teorema}

\begin{definicion}{Un poliedro esta formado por un n\'umero finito de
regiones poligonales. Cada arista de una regi\'on es la arista de exactamente
otra regi\'on. si dos regiones se intersecan, lo hacen en una arista o en un
v\'ertice}{}

\end{definicion}

\begin{definicion}{Una piramide es un poliedro en el cual todas las caras,
menos una tienen un v\'ertice com\'un}{}

\end{definicion}
\begin{definicion}{Un prisma es un poliedro que sastisface estas condiciones:
\begin{lista}
 \item Hay un par de caras congruentes sobre planos paralelos.
\item Todas las dem\'as caras son paralelogramos.
\end{lista}
}{}

\end{definicion}
\begin{teorema}{dado un prisma con caras laterales rctangulares, si la altura
del prisma es $h$ y las bases tienen \'area $B$ y per\'imetro $p,$ entonces
el \'area $S$ se encuentra con la f\'ormulas $S=hp+2B$}{}
\end{teorema}
\begin{teorema}{Dada una pir\'amide regular con altura inclinada $l$ y base
con \'area $S$ se encuentra con la f\'ormula $S=\frac{1}{2} lp +B$}{}
\end{teorema}

 \begin{teorema}{El volumen de un prisma cualquiera es el producto de la
longitud de una altura por el \'area de la base}{}

 \end{teorema}
\begin{teorema}{Dada una pir\'amide de altura $h$ y \`area de la base $B,$ el
volumen se encuentra por la f\'ormula $V=\frac{1}{2} hB$.  }{}
\end{teorema}

\begin{teorema}{Dado un cilindro circular recto de altura $h,$ si la
circunferencia de la base es $C$ y el \'area de la base es $B,$ el \'area $S$
est\'a dada por la f\'ormula $$S=Ch+2B=2\pi rh +2\pi r^2$$ }{}
 
\end{teorema}

\begin{teorema}{Dado un cilindro circular recto con \'area de la base $B$ y
altura $h,$ su volumen est\'a dado por la f\'ormula. $$V=Bh=\pi r^{2}h.$$ }{}
 
\end{teorema}

\begin{teorema}{Dado un cono circular recto con altura inclinada $l,$ si la
circunferencia de su base es $S$ est\'a dada por la f\'ormula.
$$S=\frac{1}{2}lC=\pi rl + \pi r^2.$$ }{}
 
\end{teorema}
\begin{teorema}{Dado un cono circular recto con altura $h$ y \'area de la
base $B,$ el volumen est\'a dado por la f\'ormula
$$V=\frac{1}{3}hB=\frac{1}{3}\pi r^{2}h.$$}{}
 
\end{teorema}
\begin{teorema}{Dada una esfera de radio $r,$ el volumen se encuentra con la
f\'ormula $$V=\frac{1}{4}\pi r^3.$$ }{}
 
\end{teorema}
\begin{teorema}{Dada una esfera de radio $r,$ el \'area $S$ se encuentra con
la f\'ormula $$S=4\pi r^2.$$}{}
