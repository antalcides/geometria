...
%\usepackage[paperheight=20cm,paperwidth=16cm,scale=0.5,centering,letterpaper,
%top=30mm,bottom=10mm,left=10mm,right=10mm]{geometry}
\usepackage[scale=0.6,paperheight=22.9cm,%
paperwidth=21.6cm,%
%centering,%
left=2.5cm,%
right=2.5cm,%
...
%\usepackage[frame,center,letter,cam]{crop}
...
\cxset{#1}
\vbox to -1.5pt{\color{blue}\rule{\paperwidth}{0.4pt}\par\vskip-1.4pt
\rule{0.4pt}{\textheight}\rule{4cm}{0.4pt}}

\vbox to 0pt{\parbox[b]{0.45\textwidth}{%
\raggedright
\leftskip1.5cm
\contenido\par\par
 \expandafter\rule{\rulewidth@cx}{4.8cm}
}%
%\parbox[b]{0.5cm}{\includegraphics[width=0.5cm,height=9.15cm]{./chapters/shadow}}
%\hspace{-0.5cm}
\vspace{-1cm}
\parbox[b]{0.45\textwidth}{
\includegraphics[width=9.5cm,height=10cm]{./chapters/\image@cx}\par}
     }
\vspace{8.2cm}
\hspace*{-2.51cm}\hbox to 0pt{\hspace*{1.01cm}\includegraphics[width=7.43cm,height=3.8cm]{./chapters/genetics-band}
\hspace*{-2.7cm}\sffamily\color{\numbercolor@cx}\HHUGE \raise30pt\hbox{\theechap@cx}%
\hspace{1cm} \raise0.5pt
\hbox{\includegraphics[width=10.8cm,height=3.0cm]{./chapters/chapterconcept} \includegraphics{./chapters/shadow2}}
}
...
\begin{tikzpicture}[remember picture, overlay]
\draw[fill=doc!25,draw=doc!20] (2pt,0) rectangle (7,0.1pt);
\end{tikzpicture}}%
...
\vspace*{-20\p@}%
\begin{tikzpicture}[remember picture, overlay]%
\pgftext[right,x=14cm,y=0.2cm]{\color{doc!30}\Huge\sc\bfseries \contentsname};%
\draw[fill=doc!30,draw=doc!30] (10,-.75) rectangle (2,1);%
\clip (10,-.75) rectangle (2,1);
\pgftext[right,x=14cm,y=0.2cm]{\color{white}\Huge\sc\bfseries \contentsname};%
\end{tikzpicture}}%
\@starttoc{toc}}
% % % % % % % % % % %$$$$$$$$$$$$$$$$$$$ % % % % % % % % % %
...
\def\contentsname{\HHUGE \rmfamily \color{teal} Contenido}
...
{\hspace*{-25pt}} {\contentslabel{2.5em}} {} {\dotfill\contentspage}
...
\small{\parbox[s][][s]{0.30\textwidth}{\color{blue}\printcontents[chapters]{part}{1}{}}}
 }
\usepackage{chapterx}
